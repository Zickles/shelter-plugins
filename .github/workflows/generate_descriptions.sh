...
for plugin in $(cd plugins/; ls); do
  ...
  echo "" >> dist/README.md
  echo "Install url: \`https://zickles.github.io/shelter-plugins/$plugin\`">> dist/README.md
  echo "" >> dist/README.md
  ...
  echo "Install url: \`https://zickles.github.io/shelter-plugins/$plugin\`">>dist/"$plugin"/README.md
  echo "" >>dist/"$plugin"/README.md
